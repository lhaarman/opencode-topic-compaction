...
- Six genuine recorded sessions found (never eval-used): `crisp-forest` 1171 msgs, `quiet-river` 893, `brave-planet` 508, `nimble-lagoon` 503, `witty-eagle` 501, `stellar-cabin` 460 (dir `/workspaces/opencode-graph-plugin`)
